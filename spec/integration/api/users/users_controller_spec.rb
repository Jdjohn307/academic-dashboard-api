  ...
  path '/api/users/users' do
    ...
    post 'Create user' do
      ...
      parameter name: :user, in: :body, schema: {
        ...
        required: %w[name email password status]
      }
      ...
      response '201', 'created' do
        ...
        run_test! do |response|
          ...
          # make sure password hashing/authenticating works like controller spec asserted
          expect(created.authenticate(user[:password])).to eq(created)
        end
      end
