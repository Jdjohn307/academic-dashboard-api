    ...
    class CourseScheduleLinksController < BaseController
      ...
      def create
        ...
        if course_schedule_link_record.save
          ...
          render json: { errors: course_schedule_link_record.errors.full_messages.map { |msg| { title: "Invalid Data", detail: msg, status: "unprocessable_entity" } } }, status: :unprocessable_entity
        end
      end
